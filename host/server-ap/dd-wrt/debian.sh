...
start() {
	...
	mkdir -p ${CHROOT_DIR}/mnt/server-ap/sda1
	mount -o bind /tmp/mnt/sda1/exports ${CHROOT_DIR}/mnt/server-ap/sda1 
	
	mkdir -p ${CHROOT_DIR}/mnt/server-ap/sdb1
	mount -o bind /tmp/mnt/sdb1/exports ${CHROOT_DIR}/mnt/server-ap/sdb1 
...
stop() {
	...
	umount ${CHROOT_DIR}/exports/sdb1
